\section{An Optimality Criterion using Galerkin's Method}
...
Considering only the equations from projection onto a trial vector and considering $\omega$ to be known the system of equations becomes %TODO define
	\[
